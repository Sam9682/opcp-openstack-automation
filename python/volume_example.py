...
from config.models import VolumeSpec, InstanceSpec, AuthCredentials
from utils.logger import get_logger, setup_logging

logger = get_logger(__name__)


def example_volume_with_application_credentials():
    """Example: Demonstrate volume creation and attachment with application credentials."""
    print("\n=== Volume Example with Application Credentials ===")
    ...
    print("✓ Volume example with application credentials completed successfully!")
    return 0
...
if __name__ == "__main__":
    ...
    result2 = example_volume_with_application_credentials()
